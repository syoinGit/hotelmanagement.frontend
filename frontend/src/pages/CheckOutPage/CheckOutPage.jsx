  ...
  useEffect(() => {
    const fetchTodayGuests = async () => {
      try {
        ...
        console.error('本日チェックアウト予定の取得失敗:', error);
  ...
  return (
    <div className="check-in-container">
      ...
      {loading ? (
        ...
        <p className="ci-muted">本日チェックアウト予定はありません。</p>
      ) : (
                ...
                <article className="ci-card" key={res.id}>
                  ...
                  <div className="ci-card-body">
                    ...
                    <div className="ci-total">
                      総額{' '}
                      <strong className="ci-amount">
                        {formatJPY(res.totalPrice)}
                      </strong>
                    </div>
                  </div>
                  ...
                  <footer className="ci-card-footer">
                    <button
                      ...
                      onClick={() =>
                        openConfirm(res.id, g.guest?.name ?? '')
                      }
                    >
                      チェックアウト
                    </button>
      ...
      {confirmOpen && (
        <div className="ci-modal-backdrop" onClick={closeConfirm}>
          ...
          >
            <h3 className="ci-modal-title">チェックアウトの確認</h3>
            ...
            <div className="ci-modal-actions">
              ...
              <button className="ci-btn-primary" onClick={doCheckOut}>
                はい
              </button>
            </div>
          </div>
